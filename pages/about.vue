...
<template>
  <div class="m-10">
    <h3 class="font-bold text-green-600 text-2xl">About page</h3>
    ...
    <div class="mt-20">
      ...
      >
        ...
        <DxColumn data-field="Photo" :visible="false" />
        <DxEditing
            mode="popup"
            :allow-updating="true"
            :allow-adding="true"
...
<!--          <div>-->
<!--            <img class="employee-photo" :src="employee.data.Photo" alt="image">-->
